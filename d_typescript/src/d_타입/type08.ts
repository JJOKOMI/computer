...
// someValue = 123; number불가 console.log(length); 하면 undefined
// someValue = true; 해당 변수에 할당은 가능하지만 길이를 구하는 로직에 실질적인 이용 불가
...
// 타입 단언을 활용하는 예시
// : 웹 개발에서 DOM 요소를 조작할 때, 특정 DOM요소를 구체적인 HTMLlement 타입으로 선언
// >> ts가 자동으로 해당 DOM 요소의 정확한 타입을 추론 할 수 없다.

//1) HTMLButtonElement 단언  @@@중요!!!@@@
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // if(hello === true) 쓰지않아도 hello만 써도 똑같음
  // button.disabled = true; 에러 
